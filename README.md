...
[![StyleCI](https://github.styleci.io/repos/61384075/shield?branch=12.x&style=flat)](https://github.styleci.io/repos/61384075?branch=12.x)
[![Build Status](https://img.shields.io/github/actions/workflow/status/dmitry-ivanov/laravel-helper-functions/tests.yml?branch=12.x)](https://github.com/dmitry-ivanov/laravel-helper-functions/actions?query=workflow%3Atests+branch%3A12.x)
[![Coverage Status](https://img.shields.io/codecov/c/github/dmitry-ivanov/laravel-helper-functions/12.x)](https://app.codecov.io/gh/dmitry-ivanov/laravel-helper-functions/tree/12.x)
...
1. Install the package via Composer:
    ...
    ```shell script
    composer require "illuminated/helper-functions:^12.0"
    ```
