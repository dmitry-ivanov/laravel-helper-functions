...
[![StyleCI](https://styleci.io/repos/61384075/shield?branch=5.8&style=flat)](https://styleci.io/repos/61384075)
[![Build Status](https://travis-ci.org/dmitry-ivanov/laravel-helper-functions.svg?branch=5.8)](https://travis-ci.org/dmitry-ivanov/laravel-helper-functions)
[![Coverage Status](https://coveralls.io/repos/github/dmitry-ivanov/laravel-helper-functions/badge.svg?branch=5.8)](https://coveralls.io/github/dmitry-ivanov/laravel-helper-functions?branch=5.8)
...
1. Install the package via Composer:
    ...
    ```shell
    composer require "illuminated/helper-functions:5.8.*"
    ```
